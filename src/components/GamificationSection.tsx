	...
	<SectionWrapper id='anerkennung-praemien' className='bg-card/50'>
		...
		>
			...
			<p className='text-sm text-muted-foreground leading-relaxed'>
				Oma Netz Kassel ist eine komplett kostenlose Plattform. Hier verdient
				niemand Geld. Das Motivationssystem basiert auf Punkten und Reputation,
				die gegen symbolische Belohnungen von Projektpartnern getauscht werden
				können.
			</p>
		</motion.div>
