import { CheckCircle, Cloud, Database, GitBranch } from 'lucide-react'
import SectionWrapper, { SectionTitle } from './SectionWrapper'

const stack = [
	{ icon: Cloud, name: 'Vercel', desc: 'Frontend + API Deployment' },
	{ icon: Cloud, name: 'Render', desc: 'Deployment der Projekt-Präsentation' },
...
const DeploymentSection = () => (
	<SectionWrapper id='deployment'>
		<SectionTitle subtitle='Automatisiertes Deployment mit Vercel, Render, Neon und GitHub Actions'>
			Deployment & CI/CD
		</SectionTitle>

		<div className='max-w-5xl mx-auto grid md:grid-cols-4 gap-6 mb-10'>
			{stack.map((s, i) => (
