...
import { Database, Users, FileText, MessageCircle, Star, Gift, Bell, Key } from "lucide-react";
...
const tables = [
  ...
  { icon: Gift, name: "Reward & Redemption", fields: "Gamification" },
...
const DatabaseSection = () => (
  <SectionWrapper id="database" className="bg-card/50">
    ...
    <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
      ...
      <div>
        <h3 className="font-heading font-semibold text-foreground mb-4 text-lg">Relationen</h3>
        ...
        <div className="mt-8">
          <h3 className="font-heading font-semibold text-foreground mb-4 text-lg">Helper-Verifizierung</h3>
          <div className="code-block text-xs">
            <span className="text-accent">PENDING_REVIEW</span> → Admin prüft Dokumente{"\n"}
            → <span className="text-success">APPROVED</span> (kann Angebote machen){"\n"}
