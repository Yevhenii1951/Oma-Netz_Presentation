...
const points = [
	...
	},
	{
		icon: Shield,
		title: 'Lösung',
		desc: 'Community-basierte Plattform mit Gamification, die Generationen verbindet',
	},
	{
		icon: MapPin,
		title: 'Standort',
...
const OverviewSection = () => (
	<SectionWrapper id='overview'>
		<SectionTitle subtitle='Oma Netz Kassel verbindet Senioren mit freiwilligen Helfern aus der Nachbarschaft – durch eine intuitive, barrierefreie Plattform mit Echtzeit-Chat, KI-Unterstützung und Gamification.'>
			Projektübersicht
		</SectionTitle>
